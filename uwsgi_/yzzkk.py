...
class Crack():
    def __init__(self, keyword):
        self.url = 'http://bj.gsxt.gov.cn/corp-query-homepage.html'
        self.browser = webdriver.Chrome('F:\python新环境搭建\chromedriver_win32\chorme\Chrome-48.0.2564.97\\chromedriver.exe')
